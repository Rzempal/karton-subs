...
class UpdateService extends ChangeNotifier {
  ...
  String? _currentVersionName; // Full version like 0.7.26022700
  ...
  Future<void> init() async {
    try {
      ...
      // buildNumber for comparison (versionCode: Major*10^9 + Minor*10^8 + Patch)
      _currentVersion = packageInfo.buildNumber;
      // version for display (versionName: 0.7.26022700)
      ...
      if (response.statusCode == 200) {
        ...
        if (changelogRaw != null && _currentVersionName != null) {
          for (final entry in changelogRaw) {
            ...
            // Only include entries newer than currently installed version
        ...
        // Read versionCode from JSON for comparison (composite: Major*10^9 + Minor*10^8 + Patch)

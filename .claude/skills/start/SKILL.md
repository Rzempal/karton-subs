...
1. `CLAUDE.md` — system rules, project map, navigation
...
- Each step must have a verification criterion (aligned with Goal-Driven Execution from CLAUDE.md)
...
- If critical context files are missing (no README.md, no CLAUDE.md) — inform the user and ask how to proceed
